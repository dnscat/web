...
$(document).ready(function () {
  ...
  $('#item-2-github').dblclick(function () {
    window.open('https://github.com/MontanaSH');
  });


  $('#item-2-soundcloud').dblclick(function () {
    window.open('https://soundcloud.com/montana-hvh');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.com/users/885567881033691156');
  });


  $('#item-2-spotify').dblclick(function () {
    window.open('https://open.spotify.com/user/kg2kabk6iqwjr566saa472jb9?si=907c925f11754bfb');
  });
